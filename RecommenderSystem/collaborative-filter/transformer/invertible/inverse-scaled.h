#ifndef RS_TRANSFORMER_INVERTIBLE_INVERSE_SCALED_H
#define RS_TRANSFORMER_INVERTIBLE_INVERSE_SCALED_H

#include "../invertible.h"
#include "../function/scaled.h"
#include <unordered_set>

class InverseScaledInvertible: public TransformerInvertible {
public:
   InverseScaledInvertible(int const scaleSize, TransformerMinimizer &minimizer);
...
#endif // RS_TRANSFORMER_INVERTIBLE_INVERSE_SCALED_H
