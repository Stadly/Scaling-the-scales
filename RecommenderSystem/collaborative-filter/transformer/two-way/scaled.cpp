 ...
 */
ScaledTwoWay::ScaledTwoWay(int const scaleSize, TransformerMinimizer &minimizer) : TransformerTwoWay(scaleSize, minimizer) {
   m_bits = 0;
 ...
 */
std::shared_ptr<TransformerFunction const> ScaledTwoWay::deserialize(std::string const &serialized) const {
 ...
 */
double ScaledTwoWay::value(double const r) const {
 ...
 */
std::shared_ptr<TransformerFunction const> ScaledTwoWay::getFunc() const {
 ...
 */
long long ScaledTwoWay::hash() const {
