#ifndef RS_TRANSFORMER_TWOWAY_SCALED_H
#define RS_TRANSFORMER_TWOWAY_SCALED_H

#include "../two-way.h"
#include "../function/scaled.h"
#include <unordered_set>

class ScaledTwoWay: public TransformerTwoWay {
public:
   ScaledTwoWay(int const scaleSize, TransformerMinimizer &minimizer);
...
#endif // RS_TRANSFORMER_TWOWAY_SCALED_H
