#ifndef RS_LIKEMINDS_H
#define RS_LIKEMINDS_H

#include "../collaborative-filter.h"
#include "predictor/constant-distance.h"
#include "transformer/analyzed/agreement-scalar.h"

class LikeMinds: public CollaborativeFilter {
public:
   LikeMinds(Dataset const &dataset, double const minCorr = 0);
